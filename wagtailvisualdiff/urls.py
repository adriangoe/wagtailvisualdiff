...
urlpatterns = [
	...
	url(r'^(?P<revision_id>[0-9]+)/to_current/$', views.visual_diff_current, name='diff_current'),
	# ex: /wagtailvisualdiff/1234/to_previous/
	url(r'^(?P<revision_id>[0-9]+)/to_previous/$', views.visual_diff_previous, name='diff_previous'),
